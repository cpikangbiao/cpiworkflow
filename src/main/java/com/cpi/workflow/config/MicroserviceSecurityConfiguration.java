...
import com.cpi.workflow.config.oauth2.OAuth2JwtAccessTokenConverter;
import com.cpi.workflow.config.oauth2.OAuth2Properties;
import com.cpi.workflow.security.oauth2.OAuth2SignatureVerifierClient;
import com.cpi.workflow.security.AuthoritiesConstants;
...
public class MicroserviceSecurityConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/workflow/**").permitAll()
